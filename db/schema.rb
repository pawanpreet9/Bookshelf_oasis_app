...
ActiveRecord::Schema[7.0].define(version: 20_230_806_222_530) do
  ...
  create_table 'book_price_histories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.decimal 'price_at_order_placement'
  ...
  create_table 'books_genres', id: false, force: :cascade do |t|
    ...
    t.integer 'book_id', null: false
    t.index %w[book_id genre_id], name: 'index_books_genres_on_book_id_and_genre_id'
    t.index %w[genre_id book_id], name: 'index_books_genres_on_genre_id_and_book_id'
  end
  ...
  create_table 'order_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.integer 'tax_rate_history_id'
    t.decimal 'historical_book_price'
    t.index ['book_id'], name: 'index_order_items_on_book_id'
    t.index ['order_id'], name: 'index_order_items_on_order_id'
    t.index ['tax_rate_history_id'], name: 'index_order_items_on_tax_rate_history_id'
  end
  ...
  add_foreign_key 'order_items', 'tax_rate_histories'
